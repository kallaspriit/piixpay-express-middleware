...
describe("Invoice", function () {
    it("should enable serialization and de-serialization", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            expect(Piixpay_test_1.processInvoiceForSnapshot(invoice)).toMatchSnapshot();
            expect(Piixpay_test_1.processInvoiceForSnapshot(serialized)).toMatchSnapshot();
            expect(Piixpay_test_1.processInvoiceForSnapshot(deSerialized)).toEqual(invoice);
            return [2 /*return*/];
        });
    }); });
